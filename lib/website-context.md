# Muhamad Usri Yusron - Website Context

> [!NOTE]
> **Petunjuk bagi Developer (Usri)**:
> Anda dapat menghapus semua isi file ini atau menambahkan hasil scraping markdown dari Google Colab / Firecrawl Anda ke bagian bawah file ini. AI akan membaca seluruh isi file ini sebagai basis pengetahuannya.
...
## Deskripsi Keahlian & Fokus
Usri adalah seorang Full Stack Developer yang berfokus pada pembuatan aplikasi web yang interaktif dan dinamis serta memiliki spesialisasi di bidang kecerdasan buatan (AI) termasuk:
* **Web Development**: Next.js, Laravel, JavaScript, HTML, CSS (TailwindCSS)
...
## Hasil Scraping Tambahan (Firecrawl)

## Article

read or write your own articles here by joining as a contributor

[![Cover artikel: Apa Efek Menguatnya Dollar Ke Rupiah Hari Ini Bagi Para Software Developer?](https://i.imgur.com/KGRjpPU.jpeg)\
\
by mentega omega\
\
**Apa Efek Menguatnya Dollar Ke Rupiah Hari Ini Bagi Para Software Developer?** \
\
Menguatnya dolar hari ini terhadap nilai tukar rupiah tentu saja berdampak bagi seluruh sektor dan semua kalangan mulai dari orang pedesaan hingga perkotaan mer\
\
19 Mei 2026](https://muhamad-usriyusron.site/blog/apa-efek-menguatnya-dollar-ke-rupiah-hari-ini-bagi-para-software-developer)

[![Cover artikel: Top 3 Library React Agar Website-mu Terlihat Modern dan Elegant](https://i.imgur.com/jN7RKht.jpeg)\
\
by usri yusron\
\
**Top 3 Library React Agar Website-mu Terlihat Modern dan Elegant** \
\
Pernah gak sih kalian ketika ingin membuat website merasa stuck dan bingung terhadap tampilan yang akan dikembangkan apalagi kalau sebagai solo developer tanpa\
\
18 Mei 2026](https://muhamad-usriyusron.site/blog/top-3-library-react-agar-website-mu-terlihat-modern-dan-elegant)

[![Cover artikel: Arti Kata “Inna ma'al ‘usri yusrā” Dalam Surat Al-Insyirah Ayat 6](https://i.imgur.com/LWfvodR.png)\
\
by usri yusron\
\
**Arti Kata “Inna ma'al ‘usri yusrā” Dalam Surat Al-Insyirah Ayat 6** \
\
Sejak kecil kita sudah sering mendenger ayat AlQur'an yang berbunyi “Inna ma'al ‘usri yusrā”, ayat tersebut merupakan salah satu ayat yang terdapat didalam S\
\
18 Mei 2026](https://muhamad-usriyusron.site/blog/arti-kata-inna-maal-usri-yusr-dalam-surat-al-insyirah-ayat-6)

[Kontribusi penulisan artikel](https://muhamad-usriyusron.site/login) atau [Lihat Semua Artikel](https://muhamad-usriyusron.site/blog)
