...
const ArticleSchema = new mongoose.Schema(
  {
    ...
    coverImages: {
      ...
      validate: {
        ...
        message: 'Cover blog wajib memiliki lebih dari 1 gambar (minimal 2).',
      },
    },
    thumbnail: {
      type: String, // URL Cover Image pertama (wajib untuk compatibility)
      required: true,
    },
    paragraphs: [
      {
        ...
        imageUrl: {
          type: String, // URL Gambar Paragraf (opsional)
          default: '',
        },
      },
    ],
